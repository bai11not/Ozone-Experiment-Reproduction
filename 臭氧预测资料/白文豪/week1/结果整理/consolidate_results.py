...
def parse_args():
    ...
    parser.add_argument('--base_dir', type=str, default='/mnt/d/时空数据/臭氧预测资料',
                        help='Base directory')
...
def main():
    ...
    main_table_path = os.path.join(base_dir, 'paper_assets_pediffwavenet', 'table1_main_raw_comparison.csv')
    baseline_path = os.path.join(base_dir, '白文豪/week1/output', 'baseline_aligned_with_main_table.csv')
    experiment_metrics_path = os.path.join(base_dir, 'matrix_N95_PEDiffWaveNet_noleak_student_smoke_gpu', 'metrics_summary.json')
    paper_assets_dir = os.path.join(base_dir, 'paper_assets_pediffwavenet')
