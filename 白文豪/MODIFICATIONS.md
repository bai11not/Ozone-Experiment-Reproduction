...
**文件**：[week1/数据整理/analyze_missing_data.py](file:///d:/时空数据/白文豪/week1/数据整理/analyze_missing_data.py)
...
**文件**：[week1/数据整理/analyze_station_locations.py](file:///d:/时空数据/白文豪/week1/数据整理/analyze_station_locations.py)
...
**文件**：[week1/数据整理/plot_time_series.py](file:///d:/时空数据/白文豪/week1/数据整理/plot_time_series.py)
...
**文件**：[week1/baseline/run_baseline_evaluation.py](file:///d:/时空数据/白文豪/week1/baseline/run_baseline_evaluation.py)
...
**文件**：[week1/baseline/baseline_summary.py](file:///d:/时空数据/白文豪/week1/baseline/baseline_summary.py)
...
**文件**：[week1/baseline/baseline_run_commands.md](file:///d:/时空数据/白文豪/week1/baseline/baseline_run_commands.md)
...
**修改文件**：
- [plot_time_series.py](file:///d:/时空数据/白文豪/week1/数据整理/plot_time_series.py)
- [analyze_missing_data.py](file:///d:/时空数据/白文豪/week1/数据整理/analyze_missing_data.py)
- [analyze_station_locations.py](file:///d:/时空数据/白文豪/week1/数据整理/analyze_station_locations.py)
...
**文件列表**：
- [consolidate_results.py](file:///d:/时空数据/白文豪/week1/结果整理/consolidate_results.py) - 统一结果整理脚本

**输出文件**（位于 `week1/结果整理/output/`）：
...
cd /mnt/d/时空数据/臭氧预测资料
source .venv/bin/activate
python3 "/mnt/d/时空数据/白文豪/week1/结果整理/consolidate_results.py"
```
