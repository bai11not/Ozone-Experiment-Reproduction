#!/bin/bash
# ============================================================
# Week 2: Person C 批量消融实验 (续跑 C02-C08)
# seed=52, full + no_diff
# 用法: bash run_person_C_continue.sh
# ============================================================
set -euo pipefail
...
# ==================== C02-C08 (skip C01, already done) ====================

echo "============================================="
echo "Week 2: Person C - Ablation Experiments (C02-C08)"
echo "seed=52, full + no_diff"
echo "C01 already completed - starting from C02"
...
echo ""
echo "============================================="
echo "Person C: All 7 experiments (C02-C08) completed!"
